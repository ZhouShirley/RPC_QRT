...
<div class="row">
	...
	<div class= "col-md-9">
				...
				<script src="//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/js/bootstrap-datepicker.min.js"></script>
				 ...
				 <div id="eventForm" class="section">
			        <h2 for="date">Coaching Time</h2>
			            <div class="input-group input-append date form_datetime" id="datePicker" <?php if ($is_locked=="readonly"){echo "disabled='disabled'";}?>>
			                <input  type="text" class="form-control" name="date" <?php echo $is_locked ;?> />
					  ...
					  <label class="control-label" >Commentary</label>
						...
						function runBackgroundChange(first){
							...
							if (value != 0) {
								...
								if(value==1)
								document.getElementById("rating_engage").style.backgroundColor="#cc0000";
								if(value==2)
								...
								if(value==4)
									document.getElementById("rating_engage").style.backgroundColor="green";
								if(value==5)
					...
					<?php
						...
						function runBackgroundChange(first){
							...
							if (value != 0) {
								...
								if(value==1)
								document.getElementById("rating_cs").style.backgroundColor="#cc0000";
								if(value==2)
								...
								if(value==4)
									document.getElementById("rating_cs").style.backgroundColor="green";
								if(value==5)
				  ...
				  <h2 class="title" for="c34">Quality Reviews</h2>
						...
						function runBackgroundChange(first){
							...
							if (value != 0) {
								...
								if(value==1)
								document.getElementById("rating_quality").style.backgroundColor="#cc0000";
								if(value==2)
								...
								if(value==4)
									document.getElementById("rating_quality").style.backgroundColor="green";
								if(value==5)
				  ...
				  <h2 class="title" for="c34">Schedule Adherance</h2>
						...
						function runBackgroundChange(first){
							...
							if (value != 0) {
								...
								if(value==1)
								document.getElementById("rating_pr").style.backgroundColor="#cc0000";
								if(value==2)
								...
								if(value==4)
									document.getElementById("rating_pr").style.backgroundColor="green";
								if(value==5)
					  ...
					  <label class="control-label" >Commentary</label>
						...
						function runBackgroundChange(first){
							...
							if (value != 0) {
								...
								if(value==1)
								document.getElementById("rating_growth").style.backgroundColor="#cc0000";
								if(value==2)
								...
								if(value==4)
									document.getElementById("rating_growth").style.backgroundColor="green";
								if(value==5)
			...
			<input type="checkbox" name="agree" id="agree" value=0  <?php if ($opened['agree']==1){echo ("checked");}?>/>  I agree with the contents of this coaching sheet (Employee Acknowledgement)
				...
				echo "<h4>".$employee_data['fullname']."</h4>";
					...
					foreach ($r1 as $sub_rec){
						...
						if ($sub_rec['is_locked']=="readonly"){
							...
							echo "<a href = 'index.php?id=". $sub_rec['id']."'>"."<p class='list-group-item-heading'><span class='glyphicon glyphicon-lock'></span>". mc_decrypt($sub_rec['title'],ENCRYPTION_KEY)."</p>"."</a>";
							
						}else{

							echo "<a  href = 'index.php?id=". $sub_rec['id']."'>"."<p class='list-group-item-heading'>". mc_decrypt($sub_rec['title'],ENCRYPTION_KEY)."</>"."</a>";
