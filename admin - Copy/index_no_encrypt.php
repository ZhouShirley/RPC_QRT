	...
	<div class= "col-md-9">
				...
				<h2 class="title" >Goal 1: Engagement</h2>	
					<div class="form-group">
					  <label class="control-label" >Commentary</label>
						...
						<?php
						if ($opened['rating_engage']==1){$r1="selected";}else{$r1="";};
						if ($opened['rating_engage']==2){$r2="selected";}else{$r2="";};
						if ($opened['rating_engage']==3){$r3="selected";}else{$r3="";};
						if ($opened['rating_engage']==4){$r4="selected";}else{$r4="";};
						if ($opened['rating_engage']==2){$r5="selected";}else{$r5="";};
		...
		<div class= "col-md-3" id="sidebar">
			...
			<?php
				...
				$com_engage = mysqli_real_escape_string($dbc, $_POST['com_engage']);
