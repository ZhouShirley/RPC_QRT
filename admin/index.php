...
//if ($url_prodtype=="auto"&$url_trantype=="RenewalPrep"){
	if (isset($_GET['form_id'])){
		$q="SELECT * FROM review WHERE form_id='$form_id' GROUP BY section ORDER BY 'question_id'";
		error_log("form id is set");
	...
	<textarea type="text"  class="form-control" rows="2" id="<?php echo $var_comment?>" name="<?php echo $var_comment?>"  <?php echo $is_locked ;?> ><?php echo $current_question['comment'];?>
	</textarea>	
